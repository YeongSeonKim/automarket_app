...
//            TabHost.TabSpec ts = tabHost.newTabSpec("") ;
//
...
//            tabHost.addTab(ts)  ;
            ...
            //tabHost.addTab(tabHost.newTabSpec("1").setContent(R.id.tab1).setIndicator("과일"));
            TabHost.TabSpec tab1 = tabHost1.newTabSpec("1").setContent(R.id.content1).setIndicator("과일");
            tabHost1.addTab(tab1);

            // 두 번째 Tab. (탭 표시 텍스트:"채소"), (페이지 뷰:"tab2")
            TabHost.TabSpec tab2 = tabHost1.newTabSpec("2").setContent(R.id.content2).setIndicator("채소");
            tabHost1.addTab(tab2);

            // 세 번째 Tab. (탭 표시 텍스트:"쌀 / 잡곡"), (페이지 뷰:"tab3")
            TabHost.TabSpec tab3 = tabHost1.newTabSpec("3").setContent(R.id.content3).setIndicator("쌀 / 잡곡");
            tabHost1.addTab(tab3);

            // 네 번째 Tab. (탭 표시 텍스트:"정육"), (페이지 뷰:"tab4")
            TabHost.TabSpec tab4 = tabHost1.newTabSpec("4").setContent(R.id.content4).setIndicator("정육");
            tabHost1.addTab(tab4);


            // 다섯 번째 Tab. (탭 표시 텍스트:"해산물"), (페이지 뷰:"tab5")
            TabHost.TabSpec tab5 = tabHost1.newTabSpec("5").setContent(R.id.content5).setIndicator("해산물");
            tabHost1.addTab(tab5);

            // 여섯 번째 Tab. (탭 표시 텍스트:"유제품"), (페이지 뷰:"tab6")
            TabHost.TabSpec tab6 = tabHost1.newTabSpec("6").setContent(R.id.content6).setIndicator("유제품");
